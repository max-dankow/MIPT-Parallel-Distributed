...
public class WordCount extends Configured implements Tool{
    ...
    public static class WordMapper extends Mapper<LongWritable, Text, Text, IntWritable> {
        ...
        public void map(LongWritable offset, Text line, Context context) throws IOException, InterruptedException {
            String strLine = line.toString().replaceAll("[^a-zA-Z0-9]"," ");
            for (String element: strLine.split("\\s+")) {
    ...
    public int run(String[] strings) throws Exception {
        ...
        // Reducer output types + optimization for other OutputFormatClass
        ...
        return 0; //ждём пока закончится Job и возвращаем результат
    }
